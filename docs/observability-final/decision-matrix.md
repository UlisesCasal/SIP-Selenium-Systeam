...
## Conexión con el ADR 0012

Nuestro contexto en el TP es **C1 (Startup OSS-only)** con características de **C5 (K8s nativo)**. La matriz confirma la decisión del ADR 0012:

> **OTel Collector como pipeline + Loki como backend de logs + Grafana como visualizador + Jaeger para trazas.**

Si el contexto cambiara hacia **C2 (Mid enterprise)** evaluaríamos Datadog o EFK. Si cambiara hacia **C3 (Regulated)** evaluaríamos Splunk. El ADR 0012 tiene plan de evolución para ambos casos a 12 y 24 meses.

---

*Última actualización: 2026-05-11. Los veredictos reflejan mediciones propias (measurements.md), documentación oficial de cada herramienta, y experiencia operativa durante el TP 2.*
