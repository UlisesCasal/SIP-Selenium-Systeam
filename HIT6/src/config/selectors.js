...
module.exports = {
  ...
  results: {
    ...
    freeShipping: [
      By.xpath(
        './/span[contains(translate(text(), "ENVÍO GRATIS", "envío gratis"), "envío gratis")]',
      ),
      By.css(".ui-pb-highlight"),
    ],
    installments: [
      By.xpath(
        './/span[contains(translate(text(), "CUOTAS", "cuotas"), "cuotas")]',
      ),
  ...
  filters: {
    ...
    officialStores: By.xpath(
      '//*[@id="root-app"]//span[text()="Tiendas oficiales"]',
    ),
